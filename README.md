...
`git clone https://github.com/CrossDark/AbyssBook.git "$HOME/Library/Application Support/typst/packages/local/abyss-book/0.4.0"`
...
```typst
#import "@preview/abyss-book:0.4.0": * // 在线加载 

#import "@local/abyss-book:0.4.0": * // 或从本地加载
