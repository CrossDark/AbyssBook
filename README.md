...
`git clone https://github.com/CrossDark/AbyssBook.git "$HOME/Library/Application Support/typst/packages/local/abyss-book/0.3.4"`

# 使用

```typst
#import "@preview/abyss-book:0.3.4": * // 在线加载 

#import "@local/abyss-book:0.3.4": * // 或从本地加载
