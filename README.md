...
`git clone https://github.com/CrossDark/AbyssBook.git "$HOME/Library/Application Support/typst/packages/local/abyss-book/0.3.3"`

# 使用

```typst
#import "@preview/abyss-book:0.3.3": * // 在线加载 

#import "@local/abyss-book:0.3.3": * // 或从本地加载
